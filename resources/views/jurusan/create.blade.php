            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form action="{{ route('jrs.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                {{-- {{ csrf_field() }} --}}
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" name="ketua_jurusan" type="text" /></div>
                                </div>
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Daya Tampung<span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" name="daya_tampung" required="required" type="text" /></div>
                                </div>
