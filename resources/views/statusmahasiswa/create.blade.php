            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form action="{{ route('statusmhsw.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                {{-- {{ csrf_field() }} --}}
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="statusMhsw_id" required="required" />
                                    </div>
                                </div>
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Nama<span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" name="nama" type="text" /></div>
                                </div>
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Nilai<span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" name="nilai" required="required" type="text" /></div>
                                </div>
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        {{-- <div id="jk" name="jk" class="btn-group" data-toggle="buttons"> --}}
                                            <label class="btn btn-secondary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                <input type="radio" name="keluar" value="y" class="join-btn"> &nbsp; y &nbsp;
                                            </label>
                                            <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                <input type="radio" name="keluar" value="t" class="join-btn"> t
                                            </label>
                                        {{-- </div> --}}
                                    </div>
                                </div>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        {{-- <div id="jk" name="jk" class="btn-group" data-toggle="buttons"> --}}
                                            <label class="btn btn-secondary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                <input type="radio" name="aktif" value="y" class="join-btn"> &nbsp; y &nbsp;
                                            </label>
                                            <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                <input type="radio" name="aktif" value="t" class="join-btn"> t
                                            </label>
                                        {{-- </div> --}}
                                    </div>
                                </div>
